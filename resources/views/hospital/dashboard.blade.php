        ...
        <div class="card bg-warning invoice-card">
            <div class="card-body d-flex">
                ...
                <div>
                    ...
                    <span class="text-white fs-18">Total Beds Available</span>
                </div>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-xxl-6 col-sm-6">
        ...
        <div class="card bg-warning invoice-card">
            <div class="card-body d-flex">
                ...
                <div>
                    <h2 class="text-white invoice-num">2478</h2>
                    <span class="text-white fs-18">Total Users Registered</span>
                </div>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-xxl-6 col-sm-6">
        ...
        <div class="card bg-warning invoice-card">
            <div class="card-body d-flex">
                ...
                <div>
                    <h2 class="text-white invoice-num">2478</h2>
                    <span class="text-white fs-18">Hospital Type</span>
                </div>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-xxl-6 col-sm-6">
        ...
        <div class="card bg-warning invoice-card">
            <div class="card-body d-flex">
                ...
                <div>
                    <h2 class="text-white invoice-num">2478</h2>
                    <span class="text-white fs-18">Blood Group Avilable</span>
                </div>
            </div>
        </div>
    </div>
